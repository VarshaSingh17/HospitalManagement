...
class Doctor 
{
    ...
    public void doctorDetails()
    {
        ...
        d[0] = new Doctor("Varsha Singh ", "        Asthma       ", "     9754661123");
        d[1] = new Doctor("Shivin Kumar ", "        Stroke       ", "     9944189724");
        d[2] = new Doctor("Namrata Dogra", "        Bleeding     ", "     8805240445");
        d[3] = new Doctor("Anad Sharma  ", "        Fainting     ", "     9195555646");
        d[4] = new Doctor("Ruchi Sharma ", "        Vomiting     ", "     7344771321");
        d[5] = new Doctor("Kartik Pal   ", "        Athritis     ", "     6298221733");
    ...
    public void doctorMenu()
    {
        ...
        { 
            ...
            int age=50;
            String medicalEmergency="Asthma";
    ...
    public void bookAppointments()
    {
        ...
        while(true)
        {
         ...
         if(choose ==1)
         {
            ...
            System.out.println("3. Bleeding -");
            System.out.println("4. Fainting -");
            System.out.println("5. Vomiting -");
            System.out.println("6. Arthritis -");
            ...
            {
            case 1:
                medicalEmergency = "Asthma";
                break;
            case 2:
                medicalEmergency = "Stroke";
                break;
            case 3:
                medicalEmergency = "Bleeding";
                break;
            case 4:
                medicalEmergency = "Fainting";
                break;
            case 5:
                medicalEmergency = "Vomiting";
                break;
            case 6:
                medicalEmergency = "Arthritis";
                break;
            case 7:
